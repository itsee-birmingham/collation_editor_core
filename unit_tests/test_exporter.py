...
class ExporterUnitTests(TestCase):
        ...
        'readings': [
            {
                ...
                'text': [
                    {
                        '5': {'t': 'υιον', 'index': '6', 'siglum': '5', 'original': 'υιον', 'rule_match': ['υιον']},
                        '35': {'t': 'υιον', 'index': '6', 'siglum': '35', 'original': 'υιον', 'rule_match': ['υιον']},
                        '38': {'t': 'υιον', 'index': '6', 'siglum': '38', 'original': 'υιον', 'rule_match': ['υιον']},
                        '02': {
                            'n': 'υιον',
                            't': 'υν',
                            'index': '6',
                            ...
                            'supplied': True,
                            'rule_match': ['[υν]'],
                            'decision_class': ['reconstructed'],
                            'decision_details': [
                                {'n': 'υιον', 't': '[υν]', 'id': 216662, 'class': 'reconstructed', 'scope': 'once'}
                            ],
                        },
                        'index': '6',
                        'verse': 'Gal.1.16',
                        'reading': ['35', '38', '5', 'L23-S3W4D1', 'basetext', '02'],
                        'basetext': {
                            't': 'υιον',
                            'index': '6',
                            'lemma': 'υιον',
                    ...
                    {
                        '5': {'t': 'αυτου', 'index': '8', 'siglum': '5', 'original': 'αυτου', 'rule_match': ['αυτου']},
                        '35': {
                            't': 'αυτου',
                            'index': '8',
                            'siglum': '35',
                ...
                'label': 'a',
                'SR_text': {'2574-2': {'text': [], 'type': 'om'}},
                'suffixes': ['V', '', '', '', '', ''],
                'witnesses': ['02', '5', '35', '38', 'L23-S3W4D1', 'basetext'],
                'subreadings': {
                    'abbreviation': [
                        {
                            'text': [
            ...
            },
            {
                ...
                'label': 'zz',
                'SR_text': {
                    '04': {'text': [], 'type': 'lac_verse', 'details': 'lac verse'},
                    'P51': {
                        'text': [
                            {
                                'P51': {
    ...
    def test_get_lemma_text(self):
        ...
        overtext = {
            'current': [
                ...
                {'original': 'a'},
                {'original': 'unit'},
                {'original': 'verse', 'pc_after': ')', 'pc_before': '('},
            ]
        }
    ...
    def test_get_label_subreading(self):
        """Test get subreading label.

        Note that subreading labels are calculated before we get here and are simply returned.
        """
        exp = Exporter()
    ...
    def test_fix_subreading_suffix(self):
        """Test that duplicate letters are correctly removed from subreading label suffixes."""
        exp = Exporter()
    ...
    def test_make_reading_main_reading_1(
        self, mocked_get_label, mocked_get_text, mocked_check_for_suffixed_reading_marker
    ):
    ...
    @patch('collation.core.exporter.Exporter.get_text')
    @patch('collation.core.exporter.Exporter.get_label')
    def test_make_reading_main_reading_2(
        self, mocked_get_label, mocked_get_text, mocked_check_for_suffixed_reading_marker
    ):
    ...
    @patch('collation.core.exporter.Exporter.get_text')
    @patch('collation.core.exporter.Exporter.get_label')
    def test_make_reading_subreading(self, mocked_get_label, mocked_get_text, mocked_check_for_suffixed_reading_marker):
        ...
        exp = Exporter()
        expected_xml = (
            '<rdg n="af" type="subreading" cause="fehler" varSeq="2" wit="206*">om.<wit><idno>206*</idno></wit></rdg>'
        )
    ...
    @patch('collation.core.exporter.Exporter.get_text')
    @patch('collation.core.exporter.Exporter.get_label')
    def test_make_reading_om_reading(self, mocked_get_label, mocked_get_text, mocked_check_for_suffixed_reading_marker):
    ...
    @patch('collation.core.exporter.Exporter.get_text')
    @patch('collation.core.exporter.Exporter.get_label')
    def test_make_reading_lac_verse_reading(
        self, mocked_get_label, mocked_get_text, mocked_check_for_suffixed_reading_marker
    ):
    ...
    @patch('collation.core.exporter.Exporter.get_text')
    @patch('collation.core.exporter.Exporter.get_label')
    def test_make_reading_overlapped_verse_reading(
        self, mocked_get_label, mocked_get_text, mocked_check_for_suffixed_reading_marker
    ):
    ...
    def test_get_app_units_positive_apparatus(self, mocked_get_lemma_text, mocked_get_witnesses, mocked_make_reading):
        """Test get_app_units on a positive apparatus with no subreadings."""
        mocked_get_lemma_text.side_effect = [['my lemma'], ['here'], ['', 'om']]
        mocked_get_witnesses.side_effect = [
            ['basetext', '6'],
            ['7', '8'],
            ['basetext'],
            ['7', '8'],
        ...
        mocked_make_reading.side_effect = [
            etree.fromstring(
                '<rdg n="a" varSeq="1" wit="basetext 6">my lemma<wit><idno>basetext</idno><idno>6</idno></wit></rdg>'
            ),
            ...
            etree.fromstring('<rdg n="b" varSeq="2" wit="7 8">my lema<wit><idno>7</idno><idno>8</idno></wit></rdg>'),
            etree.fromstring(
                '<rdg n="c" type="om" cause="fehlerMR" varSeq="3" wit="6">om.<wit><idno>6</idno></wit></rdg>'
            ),
            etree.fromstring(
                '<rdg n="a" varSeq="1" wit="basetext 8">om.<wit><idno>basetext</idno><idno>8</idno></wit></rdg>'
            ),
        ...
        # are mocked)
        apparatus = [
            {'start': 2, 'end': 4, 'readings': [{'label': 'a'}, {'label': 'b'}]},
            {
                'start': 6,
                'end': 6,
                'readings': [
        ...
        expected_xml = [
            (
                '<app type="main" n="Gal.1.1" from="2" to="4"><lem wit="basetext">my lemma</lem>'
        ...
        mocked_get_witnesses.assert_has_calls(
            [
        ...
        mocked_make_reading.assert_has_calls(
            [
                call({'label': 'a'}, 0, 'a', ['basetext', '6'], subtype=None),
                call({'label': 'b'}, 1, 'b', ['7', '8'], subtype=None),
                call({'label': 'a'}, 0, 'a', ['basetext'], subtype=None),
                call({'label': 'b'}, 1, 'b', ['7', '8'], subtype=None),
                call({'label': 'c', 'reading_classes': ['fehlerMR']}, 2, 'c', ['6'], subtype='fehlerMR'),
    ...
    @patch('collation.core.exporter.Exporter.get_witnesses')
    @patch('collation.core.exporter.Exporter.get_lemma_text')
    def test_get_app_units_positive_apparatus_subreading(
        self, mocked_get_lemma_text, mocked_get_witnesses, mocked_make_reading
    ):
        ...
        mocked_make_reading.side_effect = [
            ...
            etree.fromstring(
                '<rdg type="subreading" cause="orthographic" n="bo" '
                'varSeq="3" wit="8">mie lema<wit><idno>8</idno></wit></rdg>'
            ),
        ]  # NoQA
        context = 'Gal.1.1'
        overtext = {'current': {'id': 'basetext'}}
    ...
    @patch('collation.core.exporter.Exporter.get_witnesses')
    @patch('collation.core.exporter.Exporter.get_lemma_text')
    def test_get_app_units_negative_apparatus(self, mocked_get_lemma_text, mocked_get_witnesses, mocked_make_reading):
        ...
        mocked_make_reading.side_effect = [
            etree.fromstring('<rdg n="a" varSeq="1">my lemma</rdg>'),
            etree.fromstring('<rdg n="b" varSeq="2" wit="7 8">my lema<wit><idno>7</idno><idno>8</idno></wit></rdg>'),
        ...
        apparatus = [
            {'start': 2, 'end': 4, 'readings': [{'label': 'a'}, {'label': 'b'}]},
            {
                'start': 6,
                'end': 6,
                'readings': [{'label': 'a'}, {'label': 'b'}, {'label': 'c', 'reading_classes': ['fehlerMR']}],
            },
            {'start': 7, 'end': 7, 'readings': [{'label': 'a'}, {'label': 'b'}]},
        ]
        missing = []
    ...
    @patch('collation.core.exporter.Exporter.get_witnesses')
    @patch('collation.core.exporter.Exporter.get_lemma_text')
    def test_get_app_units_negative_apparatus_subreading(
        self, mocked_get_lemma_text, mocked_get_witnesses, mocked_make_reading
    ):
    ...
    def test_get_unit_xml_defaults(self, mocked_get_app_units):
        """Test the defaults."""
        mocked_get_app_units.return_value = [
            etree.fromstring('<app type="main" n="Gal.1.1" from="2" to="8"></app>'),
        ...
        app = {
            'context': 'Gal.1.1',
            'structure': {
                'overtext': [{'original': 'my'}, {'original': 'overtext'}],
                'apparatus': [],
                'lac_readings': ['6', '8'],
                'om_readings': ['7'],
            },
        ...
        expected_xml = (
            '<ab n="Gal.1.1-APP"><app type="lac" n="Gal.1.1"><lem wit="editorial">Whole verse</lem>'
        ...
        mocked_get_app_units.assert_called_with(
            [], {'current': [{'original': 'my'}, {'original': 'overtext'}]}, 'Gal.1.1', expected_missing
        )
        self.assertEqual(etree.tostring(xml, encoding='UTF-8').decode('UTF-8'), expected_xml)
    ...
    def test_get_unit_xml_no_consolidate_lac_or_om(self, mocked_get_app_units):
        ...
        expected_missing = []
        expected_xml = (
            '<ab n="Gal.1.1-APP"><app type="main" n="Gal.1.1" from="2" to="8" />'
    ...
    def test_get_unit_xml_unit_sorting(self, mocked_get_app_units):
        ...
        mocked_get_app_units.assert_called_with(
            expected_ordered_units, {'current': [{'original': 'my'}, {'original': 'overtext'}]}, 'Gal.1.1', []
        )
    ...
    def test_get_unit_apparatus_line_sorting(self, mocked_get_app_units):
        ...
        exp.get_unit_xml(app)
        mocked_get_app_units.assert_called_with(
            expected_app_order, {'current': [{'original': 'my'}, {'original': 'overtext'}]}, 'Gal.1.1', []
        )
    ...
    def test_export_data(self, mocked_get_unit_xml, mocked_clean_collation_unit):
        ...
        mocked_get_unit_xml.side_effect = [
