...
class PreProcessor(Regulariser):
    ...
    def process_witness_list(self, collation_input_data, accept='lcs'):
        """The first function in a chain which preprocesses the data, collates it and processes the collation result.

        Args:
            collation_input_data (dict): The configs and data for collation as generated by the _doRunCollation function
                collation editor of the regulariser.js code.
            accept (str, optional): This was intended to allow different formats to be returned but is not currently
                used or working. Defaults to 'lcs'.
    ...
    def _regularise(self, decisions, witnesses, verse, accept):
        ...
        return self._get_collation(witnesses, verse, decisions, accept)

    def _get_collation(self, witnesses, verse, decisions, accept):
        ...
        if len(witnesses['collatable']) > 0:
            ...
            collatex_response = self._do_collate(witness_list, options)
            ...
            overtext_details = self._get_overtext(verse)
