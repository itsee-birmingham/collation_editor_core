  ...
  return {
    ...
    * reactivate = a boolean saying whether this select be reactivated once it is populated*/
    populateSelect: function (data, select, options) {
      let optionsHtml, j, mapping, textKey, optionText, optionTextList;
      if (typeof options === 'undefined') {
        options = {};
      }
      optionsHtml = '';
      // this is added by default, add_select must be false to exclude it
      if (!Object.prototype.hasOwnProperty.call(options, 'add_select') || options.add_select === true) {
        if (options.add_select === true && Object.prototype.hasOwnProperty.call(options, 'select_label_details')) {
      ...
      const valueKey = Object.prototype.hasOwnProperty.call(options, 'value_key') ? options.value_key : undefined;
      const textKeys = Object.prototype.hasOwnProperty.call(options, 'text_keys') ? options.text_keys : undefined;
      for (let i = 0; i < data.length; i += 1) {
        ...
        if (Array.isArray(textKeys)) {
          for (let j = 0; j < textKeys.length; j += 1) {
            if (Object.prototype.hasOwnProperty.call(data[i], textKeys[j])) {
              textKey = textKeys[j];
              break;
            }
          }
        ...
        if ($.isPlainObject(textKey)) {
          optionTextList = [];
          j = 1;
          while (Object.prototype.hasOwnProperty.call(textKey, j)) {
            if (Object.prototype.hasOwnProperty.call(data[i], textKey[j]) &&
                  data[i][textKey[j]] !== '' && data[i][textKey[j]] !== null) {
        ...
        if (Object.prototype.hasOwnProperty.call(options, 'add_class') &&
            Object.prototype.hasOwnProperty.call(options.add_class, 'data_key') &&
            Object.prototype.hasOwnProperty.call(options.add_class, 'data_value') &&
            Object.prototype.hasOwnProperty.call(options.add_class, 'class_name') &&
            Object.prototype.hasOwnProperty.call(data[i], options.add_class.data_key) &&
            data[i][options.add_class.data_key] === options.add_class.data_value){
          mapping.className = ' class="' + options.add_class.class_name + '"';
        }
        if (Object.prototype.hasOwnProperty.call(data[i], 'disabled') && data[i].disabled === true) {
      ...
      if (Object.prototype.hasOwnProperty.call(options, 'reactivate') && options.reactivate === true) {
